...
class MoodleAppPositiveTestCases(unittest.TestCase): # container for the test

    @staticmethod # signal to Unittest that this is a function inside class (vs @classmethod)- decorator
